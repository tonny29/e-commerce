...
import { Box, TableCell, TableRow, Typography, Paper, Grid, TextField, Button, List, ListItem, ListItemButton } from '@mui/material';
            ...
            <Paper elevation={0} sx={{ p: 1, mb: 2 }}>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={2} md={2} lg={2}>
                        <Button variant="contained" sx={{ float: 'right', fontSize: '12px' }} onClick={() => setOpenInvoiceModal(true)}>Create Invoice</Button>
                    </Grid>
                </Grid>
                ...
                <BasicTable tableHeader={tableHeader}>
                    {demoInvoices.map((row, index) => (
                        ...
                        >
                            ...
                            <TableCell align="left" sx={{ fontSize: '13px' }}>Action</TableCell>
                        </TableRow>
                    ))}
                </BasicTable>

                <BillingModal openModal={openInvoiceModal} setOpenModal={setOpenInvoiceModal} />
            </Box>
