    ...
    return (
        <>
            <Paper elevation={0} sx={{ p: 1, mb: 2 }}>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={2} md={2} lg={2}>
                        <PrimaryButton variant="contained" sx={{ float: 'right', fontSize: '12px' }} onClick={() => setOpenBillingModal(true)}>Create Bill</PrimaryButton>
                    </Grid>
                </Grid>
            ...
            <Box sx={{ display: 'flex' }}>
                ...
                <BillingModal openModal={openBillingModal} setOpenModal={setOpenBillingModal} />
            </Box>
